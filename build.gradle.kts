...
paperweight {
    serverProject = project(":cubepie-server")
    ...
    usePaperUpstream(providers.gradleProperty("paperRef")) {
        withPaperPatcher {
            ...
            apiOutputDir = layout.projectDirectory.dir("cubepie-api")

            serverPatchDir = layout.projectDirectory.dir("patches/server")
            serverOutputDir = layout.projectDirectory.dir("cubepie-server")
...
tasks.generateDevelopmentBundle {
    apiCoordinates = "com.arushia.cubepie:cubepie-api"
    libraryRepositories = listOf(
        "https://repo.maven.apache.org/maven2/",
        paperMavenPublicUrl,
        // "https://my.repo/", // This should be a repo hosting your API (in this example, 'com.arushia.cubepie:cubepie-api')
    )
}
